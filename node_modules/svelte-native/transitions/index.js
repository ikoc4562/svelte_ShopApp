...
const easeInQuad = new animation.CubicBezierAnimationCurve(0.550, 0.085, 0.680, 0.530);
const easeInCubic = new animation.CubicBezierAnimationCurve(0.550, 0.055, 0.675, 0.190);
const easeInQuart = new animation.CubicBezierAnimationCurve(0.895, 0.030, 0.685, 0.220);
const easeInQuint = new animation.CubicBezierAnimationCurve(0.755, 0.050, 0.855, 0.060);
const easeInSine = new animation.CubicBezierAnimationCurve(0.470, 0.000, 0.745, 0.715);
const easeInExpo = new animation.CubicBezierAnimationCurve(0.950, 0.050, 0.795, 0.035);
const easeInCirc = new animation.CubicBezierAnimationCurve(0.600, 0.040, 0.980, 0.335);
const easeInBack = new animation.CubicBezierAnimationCurve(0.600, -0.280, 0.735, 0.045);
const easeOutQuad = new animation.CubicBezierAnimationCurve(0.250, 0.460, 0.450, 0.940);
const easeOutCubic = new animation.CubicBezierAnimationCurve(0.215, 0.610, 0.355, 1.000);
const easeOutQuart = new animation.CubicBezierAnimationCurve(0.165, 0.840, 0.440, 1.000);
const easeOutQuint = new animation.CubicBezierAnimationCurve(0.230, 1.000, 0.320, 1.000);
const easeOutSine = new animation.CubicBezierAnimationCurve(0.390, 0.575, 0.565, 1.000);
const easeOutExpo = new animation.CubicBezierAnimationCurve(0.190, 1.000, 0.220, 1.000);
const easeOutCirc = new animation.CubicBezierAnimationCurve(0.075, 0.820, 0.165, 1.000);
const easeOutBack = new animation.CubicBezierAnimationCurve(0.175, 0.885, 0.320, 1.275);
const easeInOutQuad = new animation.CubicBezierAnimationCurve(0.455, 0.030, 0.515, 0.955);
const easeInOutCubic = new animation.CubicBezierAnimationCurve(0.645, 0.045, 0.355, 1.000);
const easeInOutQuart = new animation.CubicBezierAnimationCurve(0.770, 0.000, 0.175, 1.000);
const easeInOutQuint = new animation.CubicBezierAnimationCurve(0.860, 0.000, 0.070, 1.000);
const easeInOutSine = new animation.CubicBezierAnimationCurve(0.445, 0.050, 0.550, 0.950);
const easeInOutExpo = new animation.CubicBezierAnimationCurve(1.000, 0.000, 0.000, 1.000);
const easeInOutCirc = new animation.CubicBezierAnimationCurve(0.785, 0.135, 0.150, 0.860);
const easeInOutBack = new animation.CubicBezierAnimationCurve(0.680, -0.550, 0.265, 1.550);
...
function asSvelteTransition(node, delay = 0, duration = 300, curve = enums.AnimationCurve.linear, nativeAnimationProps) {
    let svelteAnim = {
        delay: delay,
        duration: duration,
    };
    ...
    if (curve instanceof animation.CubicBezierAnimationCurve) {
    ...
    let animation$1 = null;
    let last_t = -1;
    const cancelNativeAnimation = () => {
        if (animation$1 && animation$1.isPlaying) {
            //  console.log("cancelling animation on ", node);
            let oldanimation = animation$1;
            animation$1 = null;
            oldanimation.cancel();
        }
        animation$1 = null;
    ...
    svelteAnim.tick = (t) => {
        ...
        if (!animation$1) {
            ...
            if (direction == AnimationDirection.Out) {
                ...
                nsAnimation.curve = enums.AnimationCurve.cubicBezier(finalCurve.x1, finalCurve.y1, finalCurve.x2, finalCurve.y2);
            ...
            // kick it off
            animation$1 = node.nativeView.createAnimation(nsAnimation);
            animation$1.play();
        }
    };
    return svelteAnim;
...
function fade(node, { delay = 0, duration = 400 }) {
    ...
    return asSvelteTransition(node, delay, duration, enums.AnimationCurve.linear, (t) => ({
        opacity: t * o
    }));
}
function fly(node, { delay = 0, duration = 400, easing = enums.AnimationCurve.easeOut, x = 0, y = 0 }) {
...
function slide(node, { delay = 0, duration = 400, easing = enums.AnimationCurve.easeOut }) {
...
exports.asSvelteTransition = asSvelteTransition;
exports.easings = easing;
exports.fade = fade;
exports.fly = fly;
exports.slide = slide;
