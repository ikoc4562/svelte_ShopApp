...
function registerNativeElements() {
    ...
    registerNativeViewElement('SegmentedBar', () => require('tns-core-modules/ui/segmented-bar').SegmentedBar, null, { "items": NativeElementPropType.Array });
...
function initializeLogger() {
    logger.setHandler((message, level) => {
        ...
        switch (level) {
            case LogLevel.Debug:
                traceLevel = messageType.log;
                break;
            case LogLevel.Info:
                traceLevel = messageType.info;
                break;
            case LogLevel.Warn:
                traceLevel = messageType.warn;
                break;
            case LogLevel.Error:
                traceLevel = messageType.error;
                break;
        }
...
export { ActionBarElement, BottomNavigationElement, DomTraceCategory, ElementNode, FrameElement, HeadElement, ListViewElement, LogLevel, NativeElementNode, NativeElementPropType, NativeViewElementNode, PageElement, StyleElement, SvelteKeyedTemplate, SvelteNativeDocument, TabsElement, TemplateElement, ViewNode, closeModal, createElement, goBack, initializeDom, logger, navigate, registerElement, registerNativeConfigElement, registerNativeViewElement, showModal };
