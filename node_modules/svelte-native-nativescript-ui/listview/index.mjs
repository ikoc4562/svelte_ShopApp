...
import { RadListView, ListViewViewType, ListViewLinearLayout, ListViewGridLayout, ListViewStaggeredLayout } from 'nativescript-ui-listview';
...
export default RadListViewElement;
