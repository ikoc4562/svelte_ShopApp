...
function add_css() {
	...
	style.textContent = "FlexboxLayout.svelte-p1ly0z{justify-content:center;align-items:center;background-size:cover;background-image:url(\"~/images/background.jpg\")}StackLayout.svelte-p1ly0z{width:300;padding:10 16;background-color:#f0f0f0}Image.svelte-p1ly0z{margin-bottom:20;height:70}Button.svelte-p1ly0z,TextField.svelte-p1ly0z{margin-bottom:10}.btn-primary.svelte-p1ly0z{background-color:#CB1D00;color:white;margin-left:0;margin-right:0}TextField.svelte-p1ly0z{placeholder-color:#C4AFB4;color:black}.dark.svelte-p1ly0z{background-color:#301217}.dark.svelte-p1ly0z TextField.svelte-p1ly0z{color:#C4AFB4}";
	Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["append"])(document.head, style);
}

function create_fragment(ctx) {
	var page, flexboxLayout, stackLayout, image, textField0, textField1, button0, button0_text_value, button1, button1_text_value, stackLayout_class_value, dispose;
	...
	return {
		c() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(stackLayout, "class", stackLayout_class_value = "form " + (ctx.isLoggingIn ? '' : 'dark') + " svelte-p1ly0z");
		...
		p(changed, ctx) {
			...
			if ((changed.isLoggingIn) && stackLayout_class_value !== (stackLayout_class_value = "form " + (ctx.isLoggingIn ? '' : 'dark') + " svelte-p1ly0z")) {
				Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(stackLayout, "class", stackLayout_class_value);
			}
		},
